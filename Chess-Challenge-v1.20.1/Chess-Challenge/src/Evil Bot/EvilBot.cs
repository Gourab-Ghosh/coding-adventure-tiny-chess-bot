...
namespace ChessChallenge.Example
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        int seldepth; // #DEBUG
        ulong transpositionTableSize = 8388608; // 256 MB #DEBUG
        ...
        var transpositionTable = new (ulong, byte, short, byte, ushort)[transpositionTableSize]; // (hash, depth, score, flag, bestMoveRawValue)
